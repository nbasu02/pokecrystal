...
MortyGroup:
	...
	db 28, ARIADOS,    NO_ITEM, LEECH_LIFE, SLUDGE_BOMB, SHADOW_BALL, NIGHT_SHADE
...
PryceGroup:
	...
	db 52, DEWGONG,    MINT_BERRY, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 52, SNEASEL,    BLACKGLASSES, FAINT_ATTACK, HEADBUTT, CRUNCH, BLIZZARD
...
JasmineGroup:
	...
	db 44, SKARMORY,   FOCUS_BAND, SPIKES, TOXIC, STEEL_WING, WHIRLWIND
	db 44, MAGNETON,   MAGNET, THUNDERBOLT, SUPERSONIC, OCTAZOOKA, THUNDER_WAVE
	db 45, FORRETRESS, QUICK_CLAW, TOXIC, EXPLOSION, OCTAZOOKA, PIN_MISSILE
	db 45, KINGLER,    MYSTIC_WATER, CUT, CRABHAMMER, DIG, GUILLOTINE
	db 46, SCIZOR,     SILVERPOWDER, TWINEEDLE, METAL_CLAW, SWORDS_DANCE, QUICK_ATTACK
...
ChuckGroup:
	...
	db 42, MACHAMP,    NO_ITEM, CROSS_CHOP, DYNAMICPUNCH, FAINT_ATTACK, FOCUS_ENERGY
	db 43, URSARING,   MIRACLEBERRY, SUBMISSION, DYNAMICPUNCH, FAINT_ATTACK, TAKE_DOWN
	db 45, HERACROSS,  MINT_BERRY, DYNAMICPUNCH, MEGAHORN, HORN_ATTACK, REST
	db 45, POLIWRATH,  BLACKBELT_I, HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 60, YANMA,      SILVERPOWDER, LEECH_LIFE, TOXIC, CONFUSE_RAY, DRAGONBREATH
	db 61, DUNSPARCE,  QUICK_CLAW, ROCK_SLIDE, HEADBUTT, BITE, DRAGONBREATH
	db 62, ARCANINE,   CHARCOAL, FIRE_BLAST, DRAGONBREATH, EXTREMESPEED, OUTRAGE
	db 62, AMPHAROS,   MAGNEMITE, THUNDERBOLT, DRAGONBREATH, LIGHT_SCREEN, THUNDER_WAVE
	db 65, DRAGONITE,  DRAGON_FANG, FLAMETHROWER, ICE_BEAM, THUNDERBOLT, DRAGONBREATH
	db 65, KINGDRA,    LEFTOVERS, REST, SURF, SLEEP_TALK, DRAGONBREATH
	db -1 ; end
