...
MapGroup_Dungeons:
	...
	map WhirlIslandNW, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandNE, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandSW, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandCave, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandSE, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandB1F, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandB2F, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map WhirlIslandLugiaChamber, TILESET_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
